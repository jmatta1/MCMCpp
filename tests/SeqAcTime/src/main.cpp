...
int main()
{
    ...
    const int numWalkers = 6;
    //const int numParams = 5;
    const int numParams = 2;
    const int numSteps = 65535;
    ...
    acCalc.allAutoCorrTime(startItt, endItt, numSteps+1);
