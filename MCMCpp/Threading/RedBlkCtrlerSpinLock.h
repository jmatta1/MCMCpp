...
********************************************************************************
*******************************************************************************/
#ifndef MCMCPP_THREADING_REDBLKCTRLERSPINLOCK_H
#define MCMCPP_THREADING_REDBLKCTRLERSPINLOCK_H
...
class RedBlackCtrler<ParamType, EndOfStepAction, true>
{
public:
    /*!
...
template<class ParamType, class EndOfStepAction>
RedBlackCtrler<ParamType, EndOfStepAction, true>::
RedBlackCtrler(int numThreads, Chain::Chain<ParamType>& chainRef, EndOfStepAction* ptr):
...
template<class ParamType, class EndOfStepAction>
void RedBlackCtrler<ParamType, EndOfStepAction, true>::terminateWorkers()
{
    {
...
template<class ParamType, class EndOfStepAction>
void RedBlackCtrler<ParamType, EndOfStepAction, true>::runSampling(int numSteps, int skipPoints)
{
...
template<class ParamType, class EndOfStepAction>
void RedBlackCtrler<ParamType, EndOfStepAction, true>::workerWaitForTask()
{
...
template<class ParamType, class EndOfStepAction>
void RedBlackCtrler<ParamType, EndOfStepAction, true>::workerAckTerminate()
{
...
#endif  //MCMCPP_THREADING_REDBLKCTRLERSPINLOCK_H
